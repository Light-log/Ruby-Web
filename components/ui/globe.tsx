...
//
// Integrado tal cual. Único cambio funcional: la carga del mapa apunta a
// `/geo/ne_110m_land.json` en vez de a raw.githubusercontent.com. El original
// descargaba 2,76 MB de un tercero en cada visita; el archivo local de menor
// detalle pesa 237 KB, sobra para un globo decorativo y no depende de que
// GitHub responda.
...
/** Mapa de tierra servido desde el propio sitio. */
