...
//
// Integrado tal cual lo entrega Originkit. Lo único añadido para que funcione
// en Next App Router: la directiva "use client" de arriba y el `import type
// { CSSProperties }` (el original usa `React.CSSProperties` sin importar el
// namespace React, que aquí no está en ámbito). La lógica no se ha tocado.
