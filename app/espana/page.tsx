  ...
  return (
    <main className="relative">
      ...
      <section className="relative overflow-hidden pt-3 pb-20 md:pb-28">
        ...
        <div className="mx-auto w-full max-w-7xl px-5 sm:px-6 lg:px-8 2xl:max-w-[88rem] text-center">
      ...
      <section id="soluciones" className="py-16 md:py-24">
        <div className="mx-auto w-full max-w-7xl px-5 sm:px-6 lg:px-8 2xl:max-w-[88rem]"><div className="max-w-3xl"><p className="text-xs font-semibold uppercase tracking-[0.16em] text-crimson-dark">Soluciones</p><h2 className="mt-3 font-display text-3xl text-ivory md:text-4xl">Elige el problema que necesitas resolver primero</h2></div>
